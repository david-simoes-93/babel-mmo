...
public static class GameDebug
{
    ...
    public static void Init(string logfilePath, string logBaseName, bool forwardToConsole = true)
    {
        forwardToDebug = forwardToConsole;
    ...
    {
        Console.Write(((DateTimeOffset)DateTime.Now).ToUnixTimeMilliseconds() + ": " + message);
        if (logFile != null)
            logFile.WriteLine(((DateTimeOffset)DateTime.Now).ToUnixTimeMilliseconds() + ": " + message + "\n");
    }
    ...
    {
        Console.Write(((DateTimeOffset)DateTime.Now).ToUnixTimeMilliseconds() + ": [ERR] " + message);
        if (logFile != null)
            logFile.WriteLine(((DateTimeOffset)DateTime.Now).ToUnixTimeMilliseconds() + ": [ERR] " + message + "\n");
    }
    ...
    {
        Console.Write(((DateTimeOffset)DateTime.Now).ToUnixTimeMilliseconds() + ": [WARN] " + message);
        if (logFile != null)
            logFile.WriteLine(((DateTimeOffset)DateTime.Now).ToUnixTimeMilliseconds() + ": [WARN] " + message + "\n");
    }
